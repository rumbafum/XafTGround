<%@ Control Language="C#" CodeBehind="DefaultTemplateContent.ascx.cs" ClassName="DefaultTemplateContent" Inherits="HtmlTemplateXAF.Web.DefaultTemplateContent"%>
                                ...
                                <td class="Security">
                                    <cc3:XafUpdatePanel ID="UPSAC" runat="server">
                                        <cc2:ActionContainerHolder runat="server" ID="SAC" Categories="Security" ContainerStyle="Links"
                                            PaintStyle="CaptionAndImage" CssClass="Security" ShowSeparators="True" />
                                    </cc3:XafUpdatePanel>
                                </td>
                            </tr>
                        </table>
                        <cc3:XafUpdatePanel ID="UPNTAC" runat="server">
                            <cc2:NavigationTabsActionContainer ID="NTAC" runat="server" ContainerId="ViewsNavigation"
                                ...
                                <spaceaftertabstemplate>
                                    <cc2:ActionContainerHolder ID="VN" runat="server" Categories=""
                                        ...
                                        <tr>
                                            <td>
                                                <cc3:XafUpdatePanel ID="UPEMA" runat="server">
                                                    <cc2:ActionContainerHolder CssClass="ACH MainToolbar" runat="server" ID="ActionContainerHolder1" ontainerStyle="ToolBar" 
                                Orientation="Horizontal" Categories="ObjectsCreation;Edit;RecordEdit;View;Export;Reports;Filters" Style="float: left">
                                <menu width="100%" itemautowidth="False" clientinstancename="mainMenu" BackColor="transparent" HorizontalAlign="Left">
                                    <bordertop borderstyle="None" />
                                    <borderleft borderstyle="None" />
                                    <borderright borderstyle="None" />
                                </menu>
                            </cc2:ActionContainerHolder>
                            <%--<div style="float:left"><div style="padding:5px;margin-left:10px">QUE PATIFAGEM</div></div>--%>                        
                            <cc2:ActionContainerHolder runat="server" ID="EMA" ContainerStyle="Links" Orientation="Horizontal"
                                Categories="Save;UndoRedo" CssClass="EditModeActions" Style="float: left">
                                <menu width="100%" itemautowidth="False" horizontalalign="Right" />
                            </cc2:ActionContainerHolder>
                                                </cc3:XafUpdatePanel>
                                            </td>
